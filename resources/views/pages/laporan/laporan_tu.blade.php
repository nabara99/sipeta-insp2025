...
<body>
    <table style="width: 100%; border-collapse: collapse; text-align: center; font-family: arial; font-size: 8pt;">
        ...
        <tr>
            <td colspan="3"><b>LAPORAN PERTANGGUNG JAWABAN TAMBAHAN UANG PERSEDIAAN</b></td>
        </tr>
        <tr>
                ...
                <center>
                    <table border="1" cellpadding="5"
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="4" style="text-align:right;">Tambahan Uang Persediaan Awal Periode</td>
                                <td style="text-align: right;">{{ number_format($spd->spd_nilai )}}</td>
                            </tr>
                            <tr>
                                <td colspan="4" style="text-align:right;">Tambahan Uang Persediaan Akhir Periode</td>
                                <td style="text-align: right;">
                                    {{ number_format($spd->spd_nilai - $realisasiBelanja->sum('total_realisasi')) }}
                                </td>
                            </tr>
                        </tfoot>
                    </table>
