                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Daftar Kwitansi TU</h4>
                                <a href="{{ route('tu.create') }}" class="btn btn-primary">Buat Kwitansi</a>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table table-hover">
                                        ...
                                        @foreach ($kwitansitus as $kwitansi)
                                            <tr>
                                                <td>{{str_pad($kwitansi->kw_id, 3, '0', STR_PAD_LEFT) }}/SPJ.TU- &nbsp;&nbsp;&nbsp;&nbsp;/ID/2025</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-left">
                                                        ...
                                                        @if ($kwitansi->nilai !== $kwitansi->sisa)
                                                            <a href="{{ route('pajak-tu', $kwitansi->kw_id) }}"
                                ...
                                <div class="float-right">
                                    {{ $kwitansitus->withQueryString()->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script>
        function cetak(kwitansi_id) {
            var windowCetak = window.open('/tu/' + kwitansi_id,
                "Cetak Kwitansi",
        ...
        function edit(kwitansi_id) {
            window.location.href = '/tu/' + kwitansi_id + '/edit';
        }
    </script>
@endpush
