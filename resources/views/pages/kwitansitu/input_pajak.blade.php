                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-2 col-md-2 col-sm-2">
                                            ...
                                            <input type="text" value="{{ $kwitansi->kw_id }}" class="form-control"
                                                id="kwi_id" name="kwi_id" readonly>
                                        </div>
                                        <div class="col-2 col-md-2 col-sm-2">
                                            <label for="tgl">Tanggal</label>
                                            <input type="text" value="{{ $kwitansi->tgl }}"
                                                class="form-control datepicker" id="tgl" name="tgl" readonly>
                                        </div>
                                        <div class="col-6 col-md-6 col-sm-6">
                                            <label for="hal">Uraian</label>
                                            <textarea class="form-control" data-height="80" readonly id="hal" name="hal">{{ $kwitansi->hal }}</textarea>
                                        </div>
                                        <div class="col-2 col-md-2 col-sm-2">
                                            ...
                                            @enderror"
                                                ...
                                                @foreach ($spds as $spd)
                                                    <option value="{{ $spd->id }}"
                                                        ...
                                                        {{ $spd->no_spd }} {{ $spd->spd_uraian }} tanggal
                                                        {{ $spd->spd_tgl }}</option>
                                                @endforeach
                                            </select>
                                            @error('spd_id')
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-2 col-md-2 col-sm-2">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-warning"
                                                        id="ppn">{{ number_format($kwitansi->ppn) }}</button>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        @if ($kwitansi->pph21 > 1)
                                            <div class="col-2 col-md-2 col-sm-2">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-warning"
                                                        id="pph21">{{ number_format($kwitansi->pph21) }}</button>
                                                </div>
                                            </div>
                                            <script>
                                            ...
                                            <div class="col-2 col-md-2 col-sm-2">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-info"
                                                        id="pph22">{{ number_format($kwitansi->pph22) }}</button>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        @if ($kwitansi->pph23 > 1)
                                            <div class="col-2 col-md-2 col-sm-2">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-warning"
                                                        id="pph23">{{ number_format($kwitansi->pph23) }}</button>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        @if ($kwitansi->pdaerah > 1)
                                            <div class="col-2 col-md-2 col-sm-2">
                                                ...
                                                <div class="input-group">
                                                    <button class="btn btn-info"
                                                        id="pdaerah">{{ number_format($kwitansi->pdaerah) }}</button>
                                                </div>
                                            </div>
                                            <script>
                                        ...
                                        <input type="hidden" name="jenis_pajak" id="jenis_pajak" class="form-control"
                                            readonly>
                                        <div class="col-2 col-md-2 col-sm-2">
                                            <label for="simpan_item">#</label>
                                            <div class="input-group">
                                                <button type="button" class="btn btn-success" id="simpan_item"
                                                    onclick="simpanItem()">
...
@push('scripts')
    ...
    <script>
        ...
        function hapusPajak(pajak_id) {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/pajak-kwitansi-tu/' + pajak_id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                success: function(response) {
